    ...
    <div className="about-container">
      ...
      <section className="about-project">
        <div className="about-header">
          ...
          <p className="intro">
            BookHive is a book management system built as part of my journey while learning and practicing the MERN stack. It provides efficient functionalities for managing a personal book collection, along with secure user authentication. Though it’s a solid foundation, I am continuously working to add more features and improve the system as I progress in my development skills.
          </p>
        </div>
        ...
        <div className="content-container">
          <div className="objective-card">
            ...
            <ul>
              <li>Manage and organize personal book collections.</li>
              <li>Provide a simple interface to add, update, and delete books.</li>
              <li>Support Secure user authentication.</li>
              <li>Ensure scalability and fast performance with MERN stack.</li>
            </ul>
          </div>
